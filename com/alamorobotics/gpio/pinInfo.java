...
public class pinInfo {
	...
	static {
		...
		theInfo.put("P8_13", new pinInfo("P8_13", 9, 0x44E10824, 0x024, "EHRPWM2B", 23));
		...
		theInfo.put("P8_19", new pinInfo("P8_19", 8, 0x44E10820, 0x020, "EHRPWM2A", 22));
		...
		theInfo.put("P9_14", new pinInfo("P9_14", 18, 0x44E10848, 0x048, "EHRPWM1A", 50));
		theInfo.put("P9_15", new pinInfo("P9_15", 16, 0x44E10840, 0x040, "GPIO1_16", 48));
		theInfo.put("P9_16", new pinInfo("P9_16", 19, 0x44E1084C, 0x04C, "EHRPWM1B", 51));
		...
		theInfo.put("P9_21", new pinInfo("P9_21", 85, 0x44E10954, 0x154, "UART2_TXD", 3));
		theInfo.put("P9_22", new pinInfo("P9_22", 84, 0x44E10950, 0x150, "UART2_RXD", 2));
